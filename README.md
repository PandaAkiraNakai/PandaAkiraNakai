...
Vault Obsidian de **redes y ciberseguridad** — apuntes de **Cisco IOS** (enrutamiento OSPF/EIGRP, switching/VLAN, STP, ACL, QoS, AAA, SSH) más **MikroTik** y administración SSH en Linux. Grafo de conocimiento navegable con nota índice **MOC** como cabeza del cerebro; guías originales en PDF adjuntas. `// net-codex · cisco-lab · knowledge-graph`
